...
\item It is a good idea while working with bib entries or in the main text, the liberal use of the \texttt{comment} environment produces efficient compilation.
