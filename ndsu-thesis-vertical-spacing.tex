...
\todo{Excess vertical spacing here! $>$ 3.8 grids}
...
\todo{Excess spacing below! $>$ 3.8 grids}

\begin{equation}
P(x) = ax^3+bx^2+cx+d
\end{equation}

\todo{Excess spacing here! $>$ 3.8 grids}

%\kant[3]

\kant[9]

\todo{Less spacing! $<$ 3.8 grids}
...
\todo{Excess spacing here! Around 3.8 grids} 

\kant[10-11]

\todo[color=green]{Correct spacing here! $>$ 3.8grids}
