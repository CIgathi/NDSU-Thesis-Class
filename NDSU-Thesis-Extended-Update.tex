...
\midrule
Abbrevia\-tions & ABEN, STD, TP, TN, FP, FN & \textcolor{red}{$ABEN, STD$, $TP, TN, FP$, $FN$} & Abbreviations, usually $>1$ letter long, should be always upright. This should be followed in regular text and in equations (use the \cmd{text\{\ldots\}} * in equations or math mode). Otherwise, it may be considered as a product of variables. \\
...
\item The command $>$\{\cmd{raggedright}\cmd{arraybackslash}\}p\{\ldots\} makes raggedright columns (otherwise justified)
...
%-----------------------------------------------------------------------------
\newpage
\subsection{Longtable 3:  Workaround Automatic Full-Width Long Table Using \texttt{longtblr} package}


\mytabcap[-7ex]{Workaround longtable Automatic Full-Width Long Table Using \texttt{longtblr} package}{mytabcap1}% required for special tables
\begingroup
\footnotesize
\newcommand{\tf}{\textcolor{blue}{Auto X columns of longtblr} It remains a mystery why, then, the discipline of human reason, in other words, is what first gives rise to nothing!}
...
note{} = {\footnotesize 
  ...
  colspec = {X[0.5,l] X[2.5] X[1,c] X[1.2,l] X[0.8,r]},
  rowhead = 2,
%  middlehead = {} 
}
\toprule
...
%-----------------------------------------------------------------------------
\subsection{Longtable 4: Landscape Automatic Full-Width Long Table Using \texttt{xltabular} package}
...
\multicolumn{5}{@{}p{1.346\textwidth}@{}}{\singlespacing\scriptsize{Note: First line of note.}} \\[-0.45in]
\multicolumn{5}{@{}p{1.346\textwidth}@{}}{\singlespacing\scriptsize{Note: Second line + kant [9] as \kant[9]}} 
\endlastfoot
...
%-----------------------------------------------------------------------------
\subsection{Longtable 5: Simplified Manual Full-Width Long Table With Paragraph Columns---No Repeated Caption and Header}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 6: Simplified Long Table --- No Repeated Caption and Header}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 7: Simplified Long Table---With Header But No Repeated Caption --- No Full-width---Using \texttt{l} and \texttt{r} specifiers}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 8: Simplified longtblr --- With Header But No Repeated Caption}
\vspace{-0.3in}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 9: Simplified Longtable --- With No Header or Repeated Caption - Used to Present Just Long Data}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 10: Simplified Longtblr --- With No Header or Repeated Caption - Used to Present Just Long Data}
...
%-----------------------------------------------------------------------------
\subsection{Longtable 11: Simple Long Data Table Using \texttt{tabbing} Environment}\label{lttab}
...
\italk{Applying the similar logic \texttt{longtable} when enclosed in \texttt{landscape} environment will produce the landscape long tables (\cref{longtabls}). The previous table was reproduced to demonstrate long tables in landscape format. Note the use of \cmd{setlength}\cmd{tabcolsep}\{5.25pt\}, optained through trial-and-error, to adjust the final width of the table by altering the column sepration spacing.}
