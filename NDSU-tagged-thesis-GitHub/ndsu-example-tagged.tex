...
\DocumentMetadata{
  ...
  pdfversion=2.0,
  pdfstandard=ua-2,% ua-1 is possible downgrate
...
\mytfigap[0.15in]{h!}{0.8}{utbmciadreport-ciad-frontbackground}[0pt]{A stock picture from the TeXLive 2025 texmf-dist distribution from UTBM-CIAD report.}[0pt]{A stock image from the TeXLive 2025 texmf-dist distribution from UTBM-CIAD showing a human and robotic hand meeting.}{fig:b1}
...
\mytschap[0.025in]{h!}{0.35}{LampFlowchart}{Flowchart of controls of light bulb---A scheme---using myschst command.}{A flow diagram showing the steps of troubleshooting a lamp not working.}{sch:b1}
