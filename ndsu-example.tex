...
%\documentclass[12pt,showgrid]{ndsu-thesis-2022}% vspace to be adusted

%Refer to documentation (ndsu-thesis-2022-documentation.pdf) for various options and commands

\graphicspath{{./figures/}}
%\renewcommand\myspacing{1.9} % 23 lines/page needs 1.9; other values for other fornts
