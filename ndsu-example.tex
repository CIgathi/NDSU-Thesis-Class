...
The SI units don't have gallon, feet, foot, inch, etc. However, these can be defined using \texttt{DeclareSIUnit} command and these units can be used in the regular manner with \texttt{si} and \texttt{SI} commands (See line numbers 12 through 16). 
